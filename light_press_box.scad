...
holes = [ //format [face_name, shape_name, shape_position[x_pos,y_pos,x_offs,y_offs,rotate,align], shape_size[depth,,,]]
    ...
    ["N", "Cylinder", [0,0,0,0,0,"outside"], [wall_t, 2, 24]],
    //["E", "Cylinder", [0,0,0,0,0,"outside"], [wall_t, 5, 24]], 
    //["W", "Cylinder", [0,0,0,0,0,"outside"], [wall_t, 5, 24]],  

	  ["T", "Cylinder", [-5,24,0,0,0,"outside"], [wall_t, 3.0, 24]],// led
...
posts = [ //format [face_name, shape_name shape_position[x_pos,y_pos,x_offs,y_offs,rotate,align], shape_size[depth,,,]]
	 ...
	 //["B", "Hollow_Cylinder", [24,0, 0,0, 30, "inside"], [clearance_xyz[2]+5-post_tolerance,3,0.5,16]],
	 //["B", "Hollow_Cylinder", [-10,19, 0,0, 30, "inside"], [clearance_xyz[2]+5-post_tolerance,3,0.5,16]],
	 //["B", "Hollow_Cylinder", [-10,-19, 0,0, 30, "inside"], [clearance_xyz[2]+5-post_tolerance,3,0.5,16]],
