...
holes = [ //format [face_name, shape_name, shape_position[x_pos,y_pos,x_offs,y_offs,rotate,align], shape_size[depth,,,]]
    ["N", "Cylinder", [0,-1,0,0,0,"outside"], [wall_t, 5.0, 24]], // 1/4" in
    ["W", "Cylinder", [-device_xyz[1]/2+5.5,0,0,-1,0,"outside"], [wall_t, 5.5, 24]], // 1/4" out
    ["T", "Cylinder", [-6,-11,0,0,0,"outside"], [wall_t, 3.0, 24]], // LED
    ["T", "Cylinder", [2,8,0,0,0,"inside"], [wall_t-.9, 9.0, 24]], // battery
...
//add external slotted flanges for passing a belt or strap through in Z plane on up to 4 sides
